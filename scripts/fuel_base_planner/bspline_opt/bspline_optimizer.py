...
class BsplineOptimizer:
    ...
    def __init__(self):
        ...
        ####### Config ############
        self.ld_smooth_ = 20.0
        self.ld_dist_ = 10.0
        self.ld_feasi_ = 2.0
        self.ld_start_ = 100.0
        self.ld_end_ = 0.5
        self.ld_guide_ = 1.5
        self.ld_waypt_ = 0.3
        self.ld_view_ = 0.0
        ...
        self.dlmin_ = -1.0
        self.wnl_ = 1.0
        self.max_iteration_num_[0] = 2
        self.max_iteration_num_[1] = 2000
        self.max_iteration_num_[2] = 200
        self.max_iteration_num_[3] = 200
        self.max_iteration_time_[0] = 0.0001
        self.max_iteration_time_[1] = 0.005
        self.max_iteration_time_[2] = 0.003
        self.max_iteration_time_[3] = 0.003
        self.algorithm1_ = 15
        self.algorithm2_ = 11
